 ...
 * 链形菌
 */
class Germ_3_Avatar extends BaseAvatar
{
	...
	{
		let json:any = RES.getRes("303_json");

		let png:any = RES.getRes("303_png");
	...
	protected updateMode():void
	{
		...
		let key:string = "303_" + (this._avo.grade || 1);
