 ...
 * 黏黏菌
 */
class Germ_2_Avatar extends BaseAvatar
{
	/** 模型样式 */
	...
	{
		let json:any = RES.getRes("g_302_json");

		let png:any = RES.getRes("g_302_png");
	...
	protected updateMode():void
	{
		...
		let key:string = "302_" + (this._avo.grade || 1);
